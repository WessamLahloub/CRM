...
describe('Create Contact', () => {
    ...
    it('TestONE', () => {
        ...
        cy.get(':nth-child(1) > .MuiFormControl-root > .select-body-wrapper > .MuiInputBase-root > #contactsActionsRef').click()
